    ...
    <Router>
      ...
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          <Route path="/digital-invites/:id" element={<ReelDetails />} />
          ...
          <Route path="/beautiful-weddingcards" element={<SeoBlogPage />} />
          <Route path="/wedding-invitations" element={<SeoBlogPage />} />
          <Route path="/weddingstationery" element={<SeoBlogPage />} />
        </Route>
